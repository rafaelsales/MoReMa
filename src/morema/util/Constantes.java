...
public interface Constantes {
	...
	String MSG_ERRO_PERSISTENCIA_ITEM_NAO_ENCONTRADO = "Item não encontrado.";
	String MSG_ERRO_MEMORIA_CHEIA = "Não há espaço suficiente para gravar os dados.";
	String MSG_ERRO_INESPERADO = "Erro inesperado.";
	
	String MSG_ERRO_SURVEY_TITULO_INVALIDO = "Preencha o campo título corretamente.";
